...
$lang['activation_subheading']         = 'Cliquez sur ce lien pour  %s ';
$lang['activation_link']               = 'vous connecter';
...
$lang['email_activate_heading']    = 'Activer le compte pour:<br /> %s (identifiant)';
$lang['email_activate_subheading'] = 'S\'il vous plaît cliquer sur ce lien pour :<br /> %s (identifiant).';
$lang['email_activate_link']       = 'Activez votre compte';

// Forgot Password Email
$lang['email_forgotten_password_subject'] = 'Mot de Passe Oublié - Vérification';
$lang['email_forgot_password_heading']    = 'Réinitialiser le mot de passe pour:<br /> %s (identifiant)';
$lang['email_forgot_password_subheading'] = 'Cliquez sur ce lien pour:<br /> %s (identifiant)';
$lang['email_forgot_password_link']       = 'Réinitialiser votre mot de passe';

// New Password Email
$lang['email_new_password_subject']    = 'Nouveau Mot de Passe';
$lang['email_new_password_heading']    = 'Nouveau Mot de Passe pour :<br /> %s (identifiant)';
$lang['email_new_password_subheading'] = 'Votre mot de passe a été réinitialisé à :<br /> %s (identifiant)';
