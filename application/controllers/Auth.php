...
class Auth extends MY_Controller 
{
	...
	public function forgot_password()
	{
            ...
            if ($this->form_validation->run() == false)
            {
                ...
                $this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
                $this->_render_page("auth/admin/forgot_password", $this->data);
            }
            else
            {
	...
	public function reset_password($code = NULL)
	{
            ...
            if ($user)
            {
                ...
                if ($this->form_validation->run() == false)
                {
                    ...
                    // render
                    $this->_render_page("auth/admin/reset_password", $this->data);
                }
                else
                {
                    ...
                    else
                    {
                            ...
                            {
                                    $this->session->set_flashdata('message', $this->ion_auth->errors());
                                    redirect("auth/admin/reset_password/" . $code, 'refresh');
                            }
                    }
                }
            }
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->_render_page("auth/admin/deactivate_user", $this->data);
		}
		else
		{
	...
	// create a new user
        public function create_user()
        {
            ...
            if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
            {
                print "not logged or not admin ";
                print " ".$this->ion_auth->is_admin()." <br />";
                redirect("auth", 'refresh');
            }
           # var_dump($_POST);
           if (isset($_POST) && !empty($_POST))
           {
                ...
                else
                {
                    ...
                    $data['error'] = (validation_errors() ? validation_errors() : ($this->ion_auth->errors() ? $this->ion_auth->errors() : $this->session->flashdata('message')));
                   
                            $this->load->view('templates/template', $data);
                }
                print "create_user::form valid 474 Check register($identity, ...)<br/>";
            ...
            {
                #  print "create_user::form valid 474 echec register($identity, ...)<br/>";
	...
	public function edit_user($id)
	{
		...
		$this->_render_page("auth/admin/edit_user", $this->data);
	}
	...
	public function manage_groups()
	{
		...
		else
		{
			...
			$this->_render_page("auth/admin/manage_group", $this->data);
		}
	}
	...
	public function create_group()
	{
		...
		else
		{
			...
			$this->_render_page("auth/admin/create_group", $this->data);
		}
	}
	...
	public function edit_group($id)
	{
		...
		$this->_render_page("auth/admin/edit_group", $this->data);
	}
