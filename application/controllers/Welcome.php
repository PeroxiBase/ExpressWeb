...
class Welcome extends MY_Controller {
    ...
    *   used after install process to rename install folder
    *   and redirect user on login page with recommendation on administrator password change
    * @param string $param2 
    * @return integer 
    */  
    public function install_done()
    {
        if (is_dir('install')) 
        {              
            system("mv install __install");                
    ...
    *   load form to request an account
    *
    */  
    ...
    */  
    ...
    {
        $data = array(
           'title'=>"$this->header_name: Documentation ",
    ...
    /**
    * function restricted()
    *   redirect un authorized user
    */  
    public function restricted()
    {
        $data = array(
           'title'=>"$this->header_name: Restricted access ",
           'contents' => 'restricted',
           'footer_title' => $this->footer_title,
          );
        $this->load->view('templates/template', $data);
