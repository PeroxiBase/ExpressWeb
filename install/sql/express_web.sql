...
INSERT INTO `tables` (`IdTables`, `TableName`, `MasterGroup`, `Organism`, `Submitter`, `version`, `comment`, `original_file`, `Root`) VALUES
(1, 'Myco_AnnotTest', 1, 3, 'administrator', '1', 'Test data with Rhysophagus expression set', 'annotTester.csv', 1),
(2, 'Annotation_Myco_AnnotTest', 1, 3, 'administrator', '1', 'Annotation file for table Myco_AnnotTest', 'Myco_AnnotTest', 0);
